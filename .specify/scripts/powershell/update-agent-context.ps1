...
$featureDir = "$repoRoot/specs/$currentBranch"
$newPlan = "$featureDir/plan.md"

$claudeFile = "$repoRoot/CLAUDE.md"
$geminiFile = "$repoRoot/GEMINI.md"
$copilotFile = "$repoRoot/.github/copilot-instructions.md"
$cursorFile = "$repoRoot/.cursor/rules/specify-rules.mdc"
$qwenFile = "$repoRoot/QWEN.md"
$agentsFile = "$repoRoot/AGENTS.md"
